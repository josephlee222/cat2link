...
<html>
    ...
    echo website_header("Cat2.Link - " . $error_title, '<link rel="stylesheet" href="../css/styles.css">', 'Come and browse my projects!', "https://cat2.link/img/Website_imgs/meta_projects.png");
    ?>
    <body>
